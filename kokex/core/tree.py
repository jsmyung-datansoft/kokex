...
class NodeData:
    def __init__(self, node_id, node_type, parent_node_id=None,
                 word_tag=None, sentence_tag=None, semantic_tag=None,
                 org_txt_form=None, pos_txt_form=None):
...
class ParseTree:
    ...
    def add_node(self, node_id: str, node_data: NodeData):
        ...
        if node_data.node_type in ['단어', '구', '절']:
            node_data.sentence_tag = self._compute_sentence_tag(node_data.get_last_pos_tag())
